...
│  (OpenAI API / LM Studio)   │   │    (src/motor/...)          │
│                             │   │                             │
...
- O conexión a internet para usar OpenAI API
...
# 4. El framework lo detectará automáticamente
```
...
El archivo `compendio/monstruos.json` contiene **327 monstruos** del SRD 5.1, convertidos y traducidos al español:

- ✅ Todos los stats, CA, HP, velocidades
- ✅ Acciones parseadas (ataques con bonificador y daño)
- ✅ Rasgos especiales (Magic Resistance, Pack Tactics, etc.)
- ✅ Nombres traducidos al español
- ✅ Calculador de dificultad de encuentros integrado
  ...
  "acciones": [
    {
      ...
      "impacto": [{ "tipo": "daño", "cantidad": "1d6+2", "tipo_daño": "perforante" }]
    }
  ]
}
```
...
1. **Sistema de Experiencia y Niveles**
   - Sin esto, el PJ nunca progresa. Es el corazón de D&D.
   - Afecta a todo lo demás (rasgos, conjuros, stats).

2. **Más Clases Base**
   - Solo están implementadas 4 clases (Guerrero, Pícaro, Mago, Clérigo).
   - Faltan 8 del SRD: Bárbaro, Bardo, Druida, Monje, Paladín, Explorador, Hechicero, Brujo.
...
9. Interfaz web
10. Multijugador
11. Integración con VTTs (Roll20, Foundry)
...
El framework está diseñado para funcionar con **LLMs locales** vía [LM Studio](https://lmstudio.ai/) (recomendado) o con **OpenAI API**.

Modelos recomendados:
- **Llama-3.3-70B** - Excelente calidad, buen rendimiento con KV cache
- **Qwen2.5-72B** - Muy bueno en español
- **Mistral-Large-2** - Narrativa muy rica

### ¿Es gratis?

El código es gratuito y open source. Los LLMs locales son gratuitos (solo necesitas GPU/RAM). OpenAI API tiene costes.
